...
export default {
        ...
        msg: 'Welcome, ',
	      zulu: 'by zulu 2021...',
				...
				screenItems				: [
										  ...
										  {id: "screenItem_4", parent: ["screenItem_1", "screenItem_2"], 	title: "Title 4", subTitle: "Status Danger", 	left: 200, top: 100, width: 125, height: 55, type: 3, alarm: 3},//no alarm
										  {id: "screenItem_5", parent: [], 								title: "Title 5", subTitle: "Status Info", 		left: 200, top: 200, width: 125, height: 55, type: 4, alarm: 4}//no alarm
										  ],
  ...
  watch: {
            ...
            for(var loop = 0; loop < this.screenItems.length; loop ++)
							if(this.screenItems[loop].id == id)
								return this.screenItems[loop];
					},
					...
					mouseDown: function(event){
						...
						function mouseUpEvent(_event){
							...
							const item = self.getScreenItem(sourceElement.getAttribute("id"));
					  ...
					  drawArrowConnector: function(ctx, fromx, fromy, tox, toy, color){
						 ...
						 */
						 createProcessScreenDrawBuffer: function(parent, width, height){
							...
							cvs.setAttribute("style","z-index:-1;background-color:transparent;");
            ...
            if(!clickCoords)
              return;
						...
						const menuWidth = screenItemCtxMenu.offsetWidth + 4;
						const menuHeight = screenItemCtxMenu.offsetHeight + 4;
